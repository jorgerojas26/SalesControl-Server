...
group by payments.saleId
        ...
        CASE
        WHEN saleproducts.price * sales.dolarReference < 10000
        THEN ROUND(SUM(ROUND(((saleproducts.price * sales.dolarReference)) / 100) * 100) * saleproducts.quantity)
        ELSE ROUND(SUM(ROUND(((saleproducts.price * sales.dolarReference)) / 1000) * 1000) * saleproducts.quantity) END AS invoiceTotal,
        CASE
